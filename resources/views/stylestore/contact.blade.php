            ...
            <div class="col-md-6">
                    <form action="{{ route('contact_data') }}" method="POST">
                        ...
                        <fieldset class="p-4">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6 py-2">
                                        <input type="text" placeholder="Name *" class="form-control @error('name')
                                        is-invalid
                                    ...
                                    <div class="col-lg-6 pt-2">
                                        <input type="email" name="email" placeholder="Email *" class="form-control  @error('name')
                                        is-invalid
                            ...
                            <select name="select" id="" class="form-control w-100">
                                <option value="1">Select Category</option>
                                <option value="2">Laptop</option>
                                <option value="3">iPhone</option>
                                <option value="4">Monitor</option>
                                <option value="5">I need</option>
                            </select>
