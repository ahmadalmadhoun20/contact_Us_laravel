...
<section class="blog section">
	...
	<!-- Post Image -->
	<div class="image">
		<img class="img-fluid" src="{{ asset('images/blog/post-1.jpg') }}" alt="article-01">
	</div>
	<!-- Post Title -->
	...
	<a href="single-blog.html" class="btn btn-transparent">Read More</a>
				...
				<article>
					<div class="post-slider">
					  ...
					  <div class="item"><img src="{{ asset('images/blog/post-5.jpg') }}" alt="Slider-Img-02"></div>
					  <div class="item"><img src="{{ asset('images/blog/post-3.jpg') }}" alt="Slider-Img-03"></div>
					</div>
					<h3>Donec id dolor in erat imperdiet.</h3>
					<ul class="list-inline">
						<li class="list-inline-item">by <a href="user-profile.html">Admin</a></li>
				...
				<article>
					<div class="video overly">
						<img src="{{ asset('images/blog/post-3.jpg') }}" alt="video-thumbnail">
						<div class="video-button video-box" data-video-url="https://www.youtube.com/embed/g3-VxLQO7do?autoplay=1">
							<span><img src="{{ asset('images/blog/video-icon.png') }}" alt="video-icon"></span>
						</div>
					</div>
					<h3>Donec id dolor in erat imperdiet.</h3>
					<ul class="list-inline">
	...
	<!-- Post Image -->
	<div class="image">
		<img class="img-fluid" src="{{ asset('images/blog/post-4.jpg') }}" alt="article-01">
	</div>
	<!-- Post Title -->
	<h3>Donec id dolor in erat imperdiet.</h3>
	<ul class="list-inline">
	...
	<!-- Post Image -->
	<div class="image">
		<img class="img-fluid" src="{{ asset('images/blog/post-5.jpg') }}" alt="article-01">
	</div>
	<!-- Post Title -->
	<h3>Donec id dolor in erat imperdiet.</h3>
	<ul class="list-inline">
